...
public class CreateSupplyManagementRecordfromCSV {
	...
	public  void CreateRecord() throws Exception {
		...
		//登录78OA
	//	driver.findElement(By.xpath(".//*[@id='account']/div/input")).sendKeys(utills.getCSVTestData("valid_username"));
	//	String username = utills.getCSVTestData("valid_username");
	//	System.out.println(username +"~~~~~~~~~~~");
	//	driver.findElement(utills.getLocator("username_editbox_locator")).sendKeys(username);
		utills.driver=driver;
		//utills.getElement("username_editbox_locator").sendKeys(username);
	//	utills.inputValue(false,"valid_username", "username_editbox_locator");
		utills.inputValue(true,"admin", "username_editbox_locator");
...
//		}
	...
	public void swindow(String cwindow){
